...
namespace PiLot.Utils.OS {
	...
	/// <summary>
	/// Helper for OS interaction including services
	/// </summary>
	public class SystemHelper {
		...
		private readonly String[] SERVICES = { "renderd", "photosWatcher", "gpsLogger", "sensorsLogger", "liveClient" };
		...
		public String GetServiceStatus(String pServiceName) {
			String result;
			if (SERVICES.Contains(pServiceName)) {
