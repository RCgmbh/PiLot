...
namespace PiLot.Sensors {
	...
	/// <summary>
	/// The BMXX80 provides temperature, pressure and humidity. It works for these sensors:
	/// - BMP280
	/// - BME280
	/// - BME680
	/// For BMP180, there is a separate device available.
	/// </summary>
	public class BMXX80Device: BaseDevice, IDevice {
		...
		public BMXX80Device(String pID, Int32 pInterval, List<SensorInfo> pSensors, String pLocalAPI, LoginHelper pLoginHelper)
