...
PiLot.Templates.Tools = {
	...
	checklistsList: `
		<div>
			...
			<a href="#" class="lnkAddChecklist block"><i class="icon-plus marginRightSmall"></i><span data-text="newChecklist"></span></a>
		</div>
	`,
	...
	checklistDetails: `
		<div class="flexColumn easyShadow" style="max-width: 48em;">
			...
			<div class="pnlButtons marginTopSmall marginBottomSmall">
				...
				<a href="#" class="lnkLogbook marginAllSmall"><i class="icon-pen2 marginRightSmall"></i><span data-text="logbookEntry"></span></a>
	...
	checklistForm: `
		<div class="flexColumn easyShadow paddingAll" style="max-width: 48em;">
			...
			<div class="buttons reverse">
				<button class="btnSave semiBold" data-text="save"></button>
