...
PiLot.Templates.Stats = {
	...
	trackStatsPage: `
		<div class="contentPadding paddingRight">
			...
			<div class="pnlTotalDistanceChart">
			</div>
		</div>
	`,
		...
		<div>
			<div class="flexRow reverse" style="justify-content: space-between;">
				<div class="pnlSettings flexRowWrap grow paddingBottom" hidden>
					<div class="plhTimeframe flexColumn paddingRight grow" style="max-width:12em;">
					...
					<div class="plhInterval flexColumn paddingRight grow" style="max-width:12em;">
