...
## Demo:
There is a demo page at https://pilotdemo.roethenmund.biz/, where all users have read access. Once a day, a short trip is simulated and you will see the boat move around.
