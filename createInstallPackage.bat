...
dotnet build PiLotBackupClient -o pilotinstall\resources\pilotbackupclient -c release -r linux-arm --no-self-contained
...
dotnet build PiLotBackupApi -o pilotinstall\resources\pilotbackupapi -c release -r linux-arm --no-self-contained
